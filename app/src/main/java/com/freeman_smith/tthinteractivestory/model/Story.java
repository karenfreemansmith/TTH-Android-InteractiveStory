...
public class Story {
    ...
    public Story() {
        ...
        mPages[1]= new Page(
                R.drawable.page1,
                "You deftly land your ship near where the distress signal originated. You didn't notice anything strange on your fly-by, but there is a cave in front of you. Behind you is an abandned rover from the early 21st century.",
        ...
        mPages[2]= new Page(
                R.drawable.page2,
                "You continue your couse to Earth. Two days later, you recieve a transmission from HQ saying they have detected some sort of anomoly on the surface of mars near an abandoned rover. They ask you to investigate, but ultimately the decision is yours because your mission has already run much longer than planned and supplies are low.",
        ...
        mPages[3]= new Page(
                R.drawable.page3,
                "Your EVA suit is equiped with a headlamp, which you use to navigate the cave. After searching for a while your oxygen levels are starting to get pretty low. You know you should go refill your tank, but there's a very faint light up ahead.",
        ...
        mPages[4]= new Page(
                R.drawable.page4,
                "The rover is covered in dust and most of the solar panels are broken. But you are quite surprised to see the onboard system booted up and running. In fact, there is a message on the screen: \"%1$s, come to 28.543436, -81.369031.\" Those coordinates aren't far, but you don't know if your oxygen will last there and badk.",
